import 'package:bluppi/UI/Screens/RoomScreen/Widgets/card_loading.dart';
import 'package:bluppi/UI/Screens/RoomScreen/Widgets/room_card.dart';
              ...
              child: roomState.availableRooms.isEmpty
                  ...
                  : ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return RoomCard(room: room, isHost: isHost);
                      },
                    ),
            ),
          ],
